...
export const NewForm = () => {
  ...
  return (
    <Form
      ...
      replaceLink={`/dashboard/university/projects`}
    >
      <LangTabs
        ar={
          <>
            ...
            <div className="my-2">
              <Label htmlFor="title">مشاريع التخرج والأطروحات</Label>
              <Input
                type={"text"}
          ...
          <>
            ...
            <div className="my-2">
              <Label htmlFor="entitle">
                Graduation Projects and Theses title
              </Label>
              <Input
                type={"text"}
                className="sm:w-1/2 lg:w-1/4"
                name="entitle"
                id="entitle"
                placeholder="Graduation Projects and Theses title"
              />
            </div>
...
export const EditCenterForm = ({
  ...
  return (
    <Form
      ...
      replaceLink={`/dashboard/university/projects/${centerId}`}
    >
