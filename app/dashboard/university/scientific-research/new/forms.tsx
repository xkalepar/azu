...
export const NewForm = () => {
  ...
  return (
    <Form
      ...
      replaceLink={`/dashboard/university/scientific-research`}
    >
      <LangTabs
        ar={
          <>
            ...
            <div className="my-2">
              <Label htmlFor="title">عنوان البحث العلمي</Label>
              <Input
                type={"text"}
        ...
        en={
          <>
            ...
            <div className="my-2">
              <Label htmlFor="entitle">scientific research title</Label>
              <Input
                type={"text"}
                className="sm:w-1/2 lg:w-1/4"
                name="entitle"
                id="entitle"
                placeholder="scientific research title"
              />
            </div>
...
export const EditCenterForm = ({
  ...
  return (
    <Form
      ...
      replaceLink={`/dashboard/university/scientific-research/${centerId}`}
    >
