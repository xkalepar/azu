...
export const NewForm = () => {
  ...
  return (
    <Form
      ...
      replaceLink={`/dashboard/university/graduates`}
    >
      <LangTabs
        ar={
          <>
            ...
            <div className="my-2">
              <Label htmlFor="title">عنوان الخريجون</Label>
              <Input
                type={"text"}
        ...
        en={
          <>
            ...
            <div className="my-2">
              <Label htmlFor="entitle">graduates title</Label>
              <Input
                type={"text"}
                className="sm:w-1/2 lg:w-1/4"
                name="entitle"
                id="entitle"
                placeholder="graduates title"
              />
            </div>
...
export const EditCenterForm = ({
  ...
  return (
    <Form
      ...
      replaceLink={`/dashboard/university/graduates/${centerId}`}
    >
