...
export const NewForm = () => {
  ...
  return (
    <Form
      ...
      replaceLink={`/dashboard/university/university-activities`}
    >
      <LangTabs
        ar={
          <>
            ...
            <div className="my-2">
              <Label htmlFor="title">عنوان أنشطة الجامعة</Label>
              <Input
                type={"text"}
        ...
        en={
          <>
            ...
            <div className="my-2">
              <Label htmlFor="entitle">university activities title</Label>
              <Input
                type={"text"}
                className="sm:w-1/2 lg:w-1/4"
                name="entitle"
                id="entitle"
                placeholder="university activities title"
              />
            </div>
...
export const EditCenterForm = ({
  ...
  return (
    <Form
      ...
      replaceLink={`/dashboard/university/university-activities/${centerId}`}
    >
