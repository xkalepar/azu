  ...
  return <main>
    <div className="grid grid-cols-3 md:grid-cols-6 gap-4 my-4">
      ...
      <EditableDialog id={id} socialType={"facebook"}>
        <div className="flex flex-col jc items-center">  <FaFacebookSquare color="#1877f2" size={48} />
          <desc>facebook</desc></div>
      </EditableDialog>

      <EditableDialog id={id} socialType={"whatsapp"}>
        <div className="flex flex-col jc items-center">  <FaWhatsapp color="#34a853" size={48} />
          <desc>whatsapp</desc></div>
      </EditableDialog>

      <EditableDialog id={id} socialType={"email"}>
        <div className="flex flex-col jc items-center">  <MdAlternateEmail color="#000" size={48} />
          <desc>email</desc></div>
      </EditableDialog>

      <EditableDialog id={id} socialType={"x"}>
        <div className="flex flex-col jc items-center">  <FaXTwitter color="#000" size={48} />
          <desc>X</desc></div>
      </EditableDialog>

      <EditableDialog id={id} socialType={"phone1"}>
        <div className="flex flex-col jc items-center">  <FaPhoneAlt color="#000" size={48} />
      ...
      <EditableDialog id={id} socialType={"location"}>
        <div className="flex flex-col jc items-center">  <FaMapMarkerAlt color="#000" size={48} />
          <desc>map</desc></div>
      </EditableDialog>
