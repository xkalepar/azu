...
import { newCollageAction } from "./action";
...
export default function CollageForm({
  ...
  const [enList, setEnList] = useState<{ title: string; content: string }[]>(
    []
  );
  ...
  return (
    <form action={dispatch} className={cn(" space-y-6 ", className)}>
      ...
      >
        <div className="grid xl:grid-cols-3 sm:grid-cols-2 gap-4" dir="rtl">
          ...
          <div className="flex-1">
            <Label htmlFor="origin">تأسيس الكلية</Label>
            <Textarea
              name="origin"
              id="origin"
      ...
      >
        <div className="grid xl:grid-cols-3 sm:grid-cols-2 gap-4" dir="ltr">
          <div className="flex-1">
