...
const UpdateTeacherForm = ({ fullName, content, cv: OldCv, image: OldImage, phone }: Props) => {
    ...
    */
    return (
        <Form
            ...
            replaceLink={`/dashboard/teachers/${id}`}
        >
                ...
                {image ? (
                    ...
                    <div className=" flex flex-col ">
                        ...
                        <UploadDropzone
                            ...
                            content={{ label: "تحميل الصورة الشخصية واضحة لوجهك", button: "اختر ملفا" }}
