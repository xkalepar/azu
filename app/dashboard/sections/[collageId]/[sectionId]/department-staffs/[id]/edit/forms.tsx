  ...
  return (
    <section>
      <Form
        ...
        replaceLink={`/dashboard/sections/${collageId}/${sectionId}/${info.path}/${id}`}
      >
        ...
        <LangTabs
          ar={
            <div dir="rtl">
              <div className="flex-1">
                ...
                <Label htmlFor="title">عنوان {info.title}</Label>
                <Input
                  defaultValue={title}
                  id="title"
                  type={"text"}
                  placeholder={`ادخل ${info.title}`}
                  name={"title"}
                />
              </div>

              <div className="flex-1 my-2">
                <Label htmlFor="content">محتويات {info.title}</Label>
          ...
          en={
            <div dir="ltr">
              <div className="flex-1">
                <Input type={"hidden"} value={content} name="content" />
                <Label htmlFor="entitle">Title of the {info.enTitle}</Label>
                <Input
              ...
              <div className="flex-1">
                <Label htmlFor="encontent">{info.enTitle}</Label>
                <Input type={"hidden"} value={enContent} name="encontent" />
