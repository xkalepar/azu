  ...
  return (
    <section>
      <Form
        ...
        replaceLink={`/dashboard/sections/${collageId}/${sectionId}/academic-affairs/${id}`}
      >
        ...
        <LangTabs
          ar={
            <div dir="rtl">
              <div className="flex-1">
                ...
                <Label htmlFor="title">عنوان الشؤون الأكاديمية</Label>
                <Input
                  defaultValue={title}
                  id="title"
                  type={"text"}
                  placeholder="ادخل عنوان الشؤون الأكاديمية"
                  name={"title"}
                />
              </div>

              <div className="flex-1 my-2">
                <Label htmlFor="content">محتويات الشؤون الأكاديمية</Label>
          ...
          en={
            <div dir="ltr">
              <div className="flex-1">
                <Input type={"hidden"} value={content} name="content" />
                <Label htmlFor="entitle">Title of the academic affairs</Label>
                <Input
              ...
              <div className="flex-1">
                <Label htmlFor="encontent"> Academic affairs</Label>
                <Input type={"hidden"} value={enContent} name="encontent" />
