  ...
  return (
    <section>
      <Form
        ...
        replaceLink={`/dashboard/sections/${collageId}/${sectionId}/department-laboratories/${id}`}
      >
          ...
          ar={
            <div dir="rtl">
              <div className="flex-1">
                ...
                <Label htmlFor="title">عنوان معامل القسم</Label>
                <Input
                  defaultValue={title}
                  id="title"
                  type={"text"}
                  placeholder="ادخل معامل القسم"
                  name={"title"}
                />
              </div>

              <div className="flex-1 my-2">
                <Label htmlFor="content">محتويات معامل القسم</Label>
            ...
            <div dir="ltr">
              <div className="flex-1">
                ...
                <Label htmlFor="entitle">
                  Title of the department laboratories
                </Label>
                <Input
              ...
              <div className="flex-1">
                <Label htmlFor="encontent">department laboratories</Label>
                <Input type={"hidden"} value={enContent} name="encontent" />
