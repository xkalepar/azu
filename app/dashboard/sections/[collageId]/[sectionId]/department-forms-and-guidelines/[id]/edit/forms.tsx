...
import { editFormAction } from "../../action";
  ...
  return (
    <section>
      <Form
        ...
        replaceLink={`/dashboard/sections/${collageId}/${sectionId}/department-forms-and-guidelines/${id}`}
      >
          ...
          ar={
            <div dir="rtl">
              <div className="flex-1">
                ...
                <Label htmlFor="title">عنوان نماذج وادلة القسم</Label>
                <Input
                  defaultValue={title}
                  id="title"
                  type={"text"}
                  placeholder="ادخل نماذج وادلة القسم"
                  name={"title"}
                />
              </div>

              <div className="flex-1 my-2">
                <Label htmlFor="content">محتويات نماذج وادلة القسم</Label>
            ...
            <div dir="ltr">
              <div className="flex-1">
                ...
                <Label htmlFor="entitle">
                  Title of the epartment forms and guidelines
                </Label>
                <Input
                  defaultValue={entitle}
                  id="entitle"
                  type={"text"}
                  placeholder="Enter the title of the academic affairs"
                  name={"entitle"}
                />
              </div>

              <div className="flex-1">
                <Label htmlFor="encontent">
                  epartment forms and guidelines
                </Label>
                <Input type={"hidden"} value={enContent} name="encontent" />
