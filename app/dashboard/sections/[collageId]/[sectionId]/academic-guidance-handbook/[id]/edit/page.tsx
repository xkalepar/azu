  ...
  return (
    <section>
      ...
      >
        ...
        <BreadcrumbSeparator />
        <LinkBreadcrumbItem
          href={`/dashboard/sections/${collageId}/${sectionId}/academic-guidance-handbook`}
        >
          {"دليل االإرشاد الأكاديمي"}
        </LinkBreadcrumbItem>
        <BreadcrumbSeparator />
        <LinkBreadcrumbItem
          href={`/dashboard/sections/${collageId}/${sectionId}/academic-guidance-handbook/${id}`}
        >
