  ...
  return (
    <section>
      <Form
        ...
        replaceLink={`/dashboard/sections/${collageId}/${sectionId}/academic-guidance-handbook/${id}`}
      >
          ...
          ar={
            <div dir="rtl">
              <div className="flex-1">
                ...
                <Label htmlFor="title">عنوان دليل االإرشاد الأكاديمي</Label>
                <Input
                  defaultValue={title}
                  id="title"
                  type={"text"}
                  placeholder="ادخل دليل االإرشاد الأكاديمي"
                  name={"title"}
                />
              </div>

              <div className="flex-1 my-2">
                <Label htmlFor="content">محتويات دليل االإرشاد الأكاديمي</Label>
            ...
            <div dir="ltr">
              <div className="flex-1">
                ...
                <Label htmlFor="entitle">
                  Title of the academic guidance handbook
                </Label>
                <Input
              ...
              <div className="flex-1">
                <Label htmlFor="encontent">academic guidance handbook</Label>
                <Input type={"hidden"} value={enContent} name="encontent" />
